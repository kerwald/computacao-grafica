...
async function main() {
 ...
 /* const objHref1 = 'earth/earth.obj'; */
   const sun = await importOBJ('sun/sun.obj');
   const earth = await importOBJ('earth/earth.obj');

const { zNear, zFar, cameraPosition, cameraTarget, objOffset, parts } = earth;

  async function importOBJ( objHref ) {
